...
const Landing = ({scrollRef, scroll}) => {
  ...
  return <section id='landing' ref={scrollRef}>
    ...
    <div className='landing-banner'>
        ...
        <div className='landing-icons-div'>
          <a href="https://instagram.com/cafesarcasmo" target="blank" rel="noreferrer"> <BsInstagram className="landing-icon"/> </a>
          <a href="https://www.linkedin.com/in/nicolascrescenzi/" target="blank" rel="noreferrer"> <BsLinkedin className="landing-icon"/> </a>
          <a href="https://api.whatsapp.com/send?phone=541151275602" target="blank" rel="noreferrer"> <BsWhatsapp className="landing-icon"/> </a>
          <a href="nmatiasc@gmail.com" target="blank" rel="noreferrer">  <BsFillEnvelopeFill className="landing-icon"/></a>
        ...
        <nav className="landing-nav"> 
          <Button type='secondary' width={250}  onClick={()=>scroll('destacados')} > Cartelera </Button>
